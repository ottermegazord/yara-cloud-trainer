...
# Get training parameters from arguments
parser = argparse.ArgumentParser()
parser.add_argument('--image_dir', type=str, help='specify directory for images')
parser.add_argument('--image_size', type=int, help='specify training image size')
parser.add_argument('--train_batch_size', type=int, help='specify training batch size')
parser.add_argument('--how_many_training_steps', type=int, help='specify number of training steps')
args = parser.parse_args()

data_dir = args.image_dir
image_size = args.image_size
batch_size = args.train_batch_size
num_steps = args.how_many_training_steps

if data_dir == None:
    print('[ERROR] missing argument --image_dir=directory_for_images')
    quit()

if image_size == None:
    print('[ERROR] missing argument --image_size=length_of_square_image')
    quit()

if batch_size == None:
    print('[ERROR] missing argument --train_batch_size=batch_size_number')
    quit()

if num_steps == None:
    print('[ERROR] missing argument --how_many_training_steps=number_of_training_steps')
    quit()

# Print environment information
print(tf.__version__, tf.test.is_gpu_available(), tf.test.is_built_with_cuda(), tf.test.gpu_device_name())
